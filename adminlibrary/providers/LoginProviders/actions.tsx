...
import { ICountUser, ILogin,IUser,IUserStateContext } from "./context";
...
export const UserCountRequestAction = createAction<IUserStateContext, ICountUser>(UserActionEnum.Count,(CountUser)=>({CountUser}))